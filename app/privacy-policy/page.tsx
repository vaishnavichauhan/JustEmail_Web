            ...
            <div className="sticky top-28 bg-white border border-slate-200/90 rounded-2xl p-5 space-y-3 shadow-sm backdrop-blur-md">
              ...
              <div className="pt-4 border-t border-slate-100">
                <div className="p-3.5 bg-blue-50/70 border border-blue-100 rounded-xl text-[11px] space-y-2">
                  ...
                  <a
                    href="mailto:privacy@justemail.in"
                    className="text-blue-600 font-bold hover:underline inline-flex items-center gap-1"
                  >
                    privacy@justemail.in
          ...
          <main className="lg:col-span-3 space-y-10 text-sm leading-relaxed text-slate-700">
            ...
            <section id="contact-privacy" className="scroll-mt-28 bg-gradient-to-br from-white via-blue-50/50 to-white border border-blue-200/80 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-white rounded-xl border border-slate-200/80 shadow-sm space-y-1.5">
                  <div className="text-xs text-slate-500 font-semibold uppercase tracking-wider">Email Office</div>
                  <a href="mailto:privacy@justemail.in" className="text-blue-600 font-bold hover:underline flex items-center gap-2 text-sm">
                    <Mail className="w-4 h-4" />
                    privacy@justemail.in
                  </a>
                </div>
                <div className="p-4 bg-white rounded-xl border border-slate-200/80 shadow-sm space-y-1.5">
                  <div className="text-xs text-slate-500 font-semibold uppercase tracking-wider">Support Desk</div>
                  <a href="tel:+919876543210" className="text-emerald-600 font-bold hover:underline flex items-center gap-2 text-sm">
