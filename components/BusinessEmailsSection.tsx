...
export default function BusinessEmailsSection({
  ...
  const [cards, setCards] = useState<BusinessEmailCard[]>([]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="p-12 text-center bg-white border border-gray-200 rounded-3xl shadow-sm space-y-3 max-w-xl mx-auto my-6">
            ...
            <div className="text-sm text-gray-600 font-bold">Loading email plans...</div>
          </div>
        ) : cards.length === 0 ? (
          <div className="p-12 text-center bg-white border border-gray-200 rounded-3xl shadow-sm space-y-3 max-w-xl mx-auto my-6">
            ...
            <p className="text-xs text-gray-500 max-w-md mx-auto leading-relaxed">
              No active email plans are currently configured. Please check back soon or contact admin.
            </p>
          </div>
        ) : (
          <>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`pt-5 flex items-center justify-between border-t ${isDark ? "border-slate-800" : "border-gray-100"
                          ...
                          <div>
                            <div className={`text-2xl font-extrabold tracking-tight ${isDark ? "text-[#fff]" : "text-gray-900"}`}>
                              {card.price}
